...
def main():
    ...
    both=g.get('decision')==expected and n.get('decision')==expected
    ...
    print(json.dumps({'terminal':terminal,'both_accept':both,'strict_witness_count':a.get('strict_witness_count'),'selected_index':None if a.get('selected') is None else a['selected']['index']},sort_keys=True));return 0
