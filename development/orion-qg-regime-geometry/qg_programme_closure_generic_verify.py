...
ROOT=Path(__file__).resolve().parents[2]; DEV=ROOT/'development/orion-qg-regime-geometry'; QG=ROOT/'research/extensions/orion-qg'; RESULT=ROOT/'artifacts/orion-qg-programme-scientific-closure.json'; INDEX=DEV/'QG_PROGRAMME_CLOSURE_EVIDENCE_V1.json'; PROTOCOL=DEV/'QG_PROGRAMME_SCIENTIFIC_CLOSURE_PROTOCOL_V1.md'; OUT=ROOT/'artifacts/orion-qg-programme-closure-generic.json'; TOKEN='ORIONQG_PROGRAMME_CLOSURE_GENERIC='
def canonical(v): return json.dumps(v,sort_keys=True,separators=(',',':'),allow_nan=False)
def main():
 a=json.loads(RESULT.read_text()); idx=json.loads(INDEX.read_text()); u=dict(a); obs=u.pop('result_digest',None); e=idx['evidence']; expected={'portfolio','qg18','qg17r','qg15c','qg10c','qg11c','qg14c','qg7d'}
 closure_types={
  'portfolio':'MIXED_THEOREM_REFUTATION_BOUNDARIES_PRESERVED',
  'qg18':'KAPPA_IS_2',
  'qg17r':'NO_SUPPORT2_WITNESS',
  'qg15c':'STILL_INSUFFICIENT',
  'qg10c':'DONOR_DEPENDENT_OR_WEAK',
  'qg11c':'REAL_ESTIMATOR_CANNOT_CHECK',
  'qg14c':'HIDDEN_COUPLING_REFUTES_LOCAL_SELECTION',
  'qg7d':'CANNOT_CHECK_ALL_N_PINNED_CLOSURE'}
 checks={
