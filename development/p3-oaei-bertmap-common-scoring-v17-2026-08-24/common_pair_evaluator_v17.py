#!/usr/bin/env python3
"""Frozen exact-pair evaluator for P3 V17.
...
BERTMAP_RESULT = ROOT / "BERTMAP_RESULT_V17.json"
REFERENCE = ROOT / "inputs/REFERENCE_FROZEN_V17.rdf"
...
OUT_JSON = ROOT / "COMMON_PAIR_METRICS_V17.json"
OUT_MD = ROOT / "COMMON_PAIR_METRICS_V17.md"
...
def main() -> int:
    ...
    if sha256(Path(__file__)) != protocol["frozen_code"]["common_pair_evaluator_v17.py"]:
    ...
    terminal = (
        "P3_V17_SAME_UNIVERSE_COMMON_SCORING_PASS__PRIMARY_COMMON_CLASS_PAIR_"
        f"{primary_winner}__ONE_PUBLIC_OAEI_CASE_DESCRIPTIVE_ONLY__NO_POPULATION_OR_GENERAL_SUPERIORITY_AUTHORITY"
    )
    result = {
        "schema_version": "orion.p3.same-universe-common-pair-metrics.v17",
        ...
        "claim_boundary": [
            ...
            "the primary estimand is class-to-class because BERTMap V17 has no property-matching opportunity",
    ...
    OUT_MD.write_text(
        "# P3 V17 same-universe common scoring\n\n"
        f"Terminal: `{terminal}`\n\n"
        ...
        "|---|---:|---:|---:|---:|---:|---:|---|\n"
        f"| Primary common class pair | {p['AML_V3_2']['precision']['decimal']:.6f} | {p['AML_V3_2']['recall']['decimal']:.6f} | {p['AML_V3_2']['f1']['decimal']:.6f} | {p['BERTMAP_V17']['precision']['decimal']:.6f} | {p['BERTMAP_V17']['recall']['decimal']:.6f} | {p['BERTMAP_V17']['f1']['decimal']:.6f} | {p['finite_case_f1_winner']} |\n"
        f"| Secondary full equivalence pair | {s['AML_V3_2']['precision']['decimal']:.6f} | {s['AML_V3_2']['recall']['decimal']:.6f} | {s['AML_V3_2']['f1']['decimal']:.6f} | {s['BERTMAP_V17']['precision']['decimal']:.6f} | {s['BERTMAP_V17']['recall']['decimal']:.6f} | {s['BERTMAP_V17']['f1']['decimal']:.6f} | {s['finite_case_f1_winner']} |\n\n"
