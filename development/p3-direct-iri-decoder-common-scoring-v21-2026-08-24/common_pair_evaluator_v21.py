#!/usr/bin/env python3
"""Frozen exact-pair evaluator for P3 V21.
...
BERTMAP_RESULT = ROOT / "BERTMAP_RESULT_V21.json"
REFERENCE = ROOT / "inputs/REFERENCE_FROZEN_V21.rdf"
...
UNIVERSE = ROOT / "UNIVERSE_MANIFEST_V21.json"
OUT_JSON = ROOT / "COMMON_PAIR_METRICS_V21.json"
OUT_MD = ROOT / "COMMON_PAIR_METRICS_V21.md"
...
def main() -> int:
    ...
    if sha256(Path(__file__)) != protocol["frozen_code"]["common_pair_evaluator_v21.py"]:
    ...
    terminal = (
        "P3_V21_SAME_UNIVERSE_COMMON_SCORING_PASS__PRIMARY_COMMON_CLASS_PAIR_"
        f"{primary_winner}__ONE_PUBLIC_OAEI_CASE_DESCRIPTIVE_ONLY__NO_POPULATION_OR_GENERAL_SUPERIORITY_AUTHORITY"
    )
    result = {
        "schema_version": "orion.p3.same-universe-common-pair-metrics.v21",
        ...
        "claim_boundary": [
            ...
            "the primary estimand is class-to-class because BERTMap V21 has no property-matching opportunity",
    ...
    OUT_MD.write_text(
        "# P3 V21 same-universe common scoring\n\n"
        f"Terminal: `{terminal}`\n\n"
        ...
        "|---|---:|---:|---:|---:|---:|---:|---|\n"
        f"| Primary common class pair | {p['AML_V3_2']['precision']['decimal']:.6f} | {p['AML_V3_2']['recall']['decimal']:.6f} | {p['AML_V3_2']['f1']['decimal']:.6f} | {p['BERTMAP_V21']['precision']['decimal']:.6f} | {p['BERTMAP_V21']['recall']['decimal']:.6f} | {p['BERTMAP_V21']['f1']['decimal']:.6f} | {p['finite_case_f1_winner']} |\n"
        f"| Secondary full equivalence pair | {s['AML_V3_2']['precision']['decimal']:.6f} | {s['AML_V3_2']['recall']['decimal']:.6f} | {s['AML_V3_2']['f1']['decimal']:.6f} | {s['BERTMAP_V21']['precision']['decimal']:.6f} | {s['BERTMAP_V21']['recall']['decimal']:.6f} | {s['BERTMAP_V21']['f1']['decimal']:.6f} | {s['finite_case_f1_winner']} |\n\n"
