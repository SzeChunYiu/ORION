/* X1-K support-16 low-c4 rows: patterns 1 2^15 and 1^3 2^12 4.
 * For c4=0 the 30 multiplicity-2 terms must span rank 3, otherwise rank-2 eta
 * gives a short zero-sum; normalize e1^2 e2^2 e3^2.  For c4=1 the 4-point plus
 * the 24 multiplicity-2 terms must span rank 3; normalize e1^4 e2^2 e3^2.
 * Enumerate the remaining mult-2/singleton support and force the final singleton.
 */
#include <stdio.h>
#include <stdint.h>
#include <string.h>
