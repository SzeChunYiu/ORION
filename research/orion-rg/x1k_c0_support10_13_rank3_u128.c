/* X1-K finite discriminator for hypothetical length-31 total-zero short-free
 ...
 *
 * Authority: bounded exact computation only; novelty/theorem authority false.
 */
#include <stdio.h>
#include <stdint.h>
#include <string.h>
