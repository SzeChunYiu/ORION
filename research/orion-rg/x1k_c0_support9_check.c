/* X1-K: exact support-9 discriminator for a hypothetical length-31
 * zero-sum short-free sequence over C_5^3.
 *
 * Previous symbolic reduction (X1K_C0_31_SATURATION_DEFECT_PROTOCOL_V1.md):
 * a SATURATED short-free sequence has no multiplicity-3 support point.  For
 ...
 *
 * Authority: prospective finite certificate only.  Novelty=false; external
 * independent replay remains required before theorem authority.
 */
...
int main(void) {
    ...
    printf("{\n");
    printf("  \"schema\": \"ORION.RG.X1K.C0Support9Check.v1\",\n");
    printf("  \"authority\": {\"novelty_claim\": false, \"theorem_authority\": false, \"isolated_replay_required\": true},\n");
    printf("  \"group\": \"C_5^3\",\n");
    printf("  \"length\": 31,\n");
