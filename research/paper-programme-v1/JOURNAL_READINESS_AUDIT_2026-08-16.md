---
> **SUPERSEDED (2026-08-17):** This audit's claim that P3 "external evaluation NEVER RUN — no system results exist" is superseded by PR #263/#264 artifacts on origin/main. The public-reference v1.1-confirmatory evaluation EXISTS and is COMPLETE. See `papers/paper-03-global-knowledge-portrait/evidence/public-reference-v1.1-confirmatory/` for CONFIRMATORY_ANALYSIS.json, SUMMARY.json, PROVENANCE.env, and publication figures/tables. This document is preserved as historical record.
