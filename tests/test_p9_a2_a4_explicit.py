...
from orion.study.p9.a2_a4_explicit import (
    AMBIGUOUS,
...
def test_history_selector_uses_admitted_failure_only_when_visible():
    ...
    assert isinstance(clean_semantic, MechanicRankingTask)
    assert isinstance(negative_semantic, MechanicRankingTask)
    ...
    assert clean.gold.value != negative.gold.value
