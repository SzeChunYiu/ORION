...
@pytest.mark.parametrize(
    ...
    (
        (
            "papers/candidates/paper-06-formal-epistemic-structures-and-mechanics/formal/check_theory_closure_v2_1.py",
            "P6 THEORY CLOSURE V2.1: PASS",
        ),
        (
            "papers/candidates/paper-07-epistemic-navigation-open-worlds/formal/check_contract_manifest_v2.py",
