...
def test_p7_frames_its_perfect_score_as_finite_conformance() -> None:
    ...
    text = _flat(PAPERS / "orion-17-epistemic-navigation-open-worlds/README.md")
...
def test_p8_names_its_gold_as_same_programme() -> None:
    ...
    text = _flat(PAPERS / "orion-18-epistemic-authority-autonomous-science/README.md")
...
def test_p14_says_its_adjudication_specification_is_internally_authored() -> None:
    ...
    text = _flat(PAPERS / "orion-24-orion-rse/MANUSCRIPT.md")
...
def test_p3_states_its_analysis_unit_for_v21() -> None:
    ...
    text = _flat(PAPERS / "orion-13-global-knowledge-portrait/THEORY_CLAIM_LEDGER_V1.md")
...
def test_p6_reads_its_counts_with_their_multiplicity() -> None:
    ...
    text = _flat(PAPERS / "orion-16-formal-epistemic-structures-and-mechanics/README.md")
...
def test_p13_marks_its_safety_endpoint_as_self_entailed() -> None:
    ...
    text = _flat(PAPERS / "orion-23-responsibility-carrying-state/PEER_REVIEW_READINESS.md")
...
def test_p12_marks_prospective_certificate_availability_cannot_check() -> None:
    text = _flat(PAPERS / "orion-22-adaptive-state-reasoning/PEER_REVIEW_READINESS.md")
...
def test_p15_separates_all_six_execution_concepts() -> None:
    ...
    text = _flat(PAPERS / "orion-25-orion-research-harness/CLAIM_EVIDENCE_LEDGER_V1.md")
...
def test_p10_separates_unexecuted_hypotheses_from_the_earned_claim() -> None:
    ...
    text = _flat(PAPERS / "orion-20-structured-problem-solving/CLAIM_EVIDENCE_LEDGER.md")
...
def test_p10_refuses_open_ended_invention_language() -> None:
    text = _flat(PAPERS / "orion-20-structured-problem-solving/TOP_TIER_PROMOTION_V1.md")
...
def test_p9_reports_its_positives_null_and_negative_together() -> None:
    ...
    text = _flat(PAPERS / "orion-19-structured-epistemic-learning/README.md")
...
def test_p12_refuses_a_cross_domain_scalar_exchange_rate() -> None:
    text = _flat(PAPERS / "orion-22-adaptive-state-reasoning/README.md")
...
def test_p1_frames_v2_2_4_as_frozen_generator_mechanism_evidence() -> None:
    ...
    text = _flat(PAPERS / "orion-11-recursive-epistemic-reconstruction/JOURNAL_READINESS.md")
...
def test_p11_integrates_the_ten_responsibility_negative() -> None:
    ...
    text = _flat(PAPERS / "orion-21-state-as-computation/CLAIM_EVIDENCE_LEDGER.md")
...
def test_p13_integrates_the_cnf_result_with_its_comparators() -> None:
    ...
    text = _flat(PAPERS / "orion-23-responsibility-carrying-state/README.md")
...
def test_p7_readiness_record_carries_the_three_landed_classes() -> None:
    ...
    text = _flat(PAPERS / "orion-17-epistemic-navigation-open-worlds/JOURNAL_READINESS_V2_1.md")
    for denominator in ("14 frozen cases", "712 protected rows", "10 cells"):
        assert denominator in text, denominator
...
def test_p11_three_documents_cite_the_same_authority() -> None:
    ...
    d = PAPERS / "orion-21-state-as-computation"
...
def test_p11_readiness_scopes_itself_to_the_width_conditioned_result() -> None:
    text = _flat(PAPERS / "orion-21-state-as-computation/PEER_REVIEW_READINESS.md")
...
def test_p15_manuscript_carries_the_three_study_arc() -> None:
    ...
    text = _flat(PAPERS / "orion-25-orion-research-harness/MANUSCRIPT.md")
...
def test_p2_has_one_compact_claim_evidence_authority_table() -> None:
    ...
    text = _flat(PAPERS / "orion-12-open-world-scientific-discovery/README.md")
