...
from .orion_rg import X1A_DAVENPORT_3_5_CAMPAIGN_MANIFEST
from .orion_rg.x1c_c45_mixed_kernel import X1C_C45_MIXED_KERNEL_CAMPAIGN_MANIFEST
...
_BUILTINS = {
    ...
    str(X1C_C45_MIXED_KERNEL_CAMPAIGN_MANIFEST["campaign_id"]): X1C_C45_MIXED_KERNEL_CAMPAIGN_MANIFEST,
}
