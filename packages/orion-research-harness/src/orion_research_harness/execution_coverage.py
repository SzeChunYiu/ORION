...
_EXACT: dict[str, OwnerSpec] = {
    ...
    "DIAGNOSE.DISCRIMINATOR.v0": OwnerSpec("orion.engine.residual_recursion", "ResidualRecursionPlanner", ExecutionMode.RECURSIVE_RUNTIME, "each atomic child carries exactly one bounded discriminator and is cost ordered"),
    ...
    "REFRAME.OBJECTIVE.v0": OwnerSpec("orion.engine.residual_recursion", "ProblemRecursionPlanner", ExecutionMode.RECURSIVE_RUNTIME, "proposal-only root/child question reframing; no scientific authority is minted"),
...
_PREFIX: tuple[tuple[str, OwnerSpec], ...] = (
    ...
    ("REFRAME.", OwnerSpec("orion.engine.operators.reframe", "ReframeOperator", ExecutionMode.DISTRIBUTED_RUNTIME, "implemented locally when safe; high-impact method changes stay development-gated")),
