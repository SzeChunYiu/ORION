...
`P9-DES-01`: model family × representation × inference budget × numerical build/provider matrix. Endpoints: cause accuracy, frontier shift, compute substitution, held-out terminal-flip prediction, and cost. Intended terminal: `CAPABILITY_ORIGIN_AND_NUMERICAL_TERMINAL_IDENTITY_PROSPECTIVELY_IDENTIFIED`.
