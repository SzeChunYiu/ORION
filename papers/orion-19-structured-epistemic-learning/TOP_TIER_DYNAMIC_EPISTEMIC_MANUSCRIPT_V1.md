...
**Where Capability Comes From: Dynamic Diagnosis of Information, Access, Computation, and Numerical Outcome Identity**
...
- Authoritative result SHA: `2c51fc541ce28fe50fb11899ea23d2dc4a468fe9`.
- Exact terminal: `OPEN_WEIGHT_AND_NUMERICAL_BUILD_CUSTODY_UNAVAILABLE`.
- Frozen denominator: 1,344 model cells plus 12 numerical-build cells, 1,356 total; zero executed cells, zero submitted GPU or Slurm jobs, and zero dropped rows.
- Unattained prerequisites: six exact checkpoint revisions and weight digests, seven content-bound representations with round-trip/leakage checks, two task generators and verifiers, strongest donor-complete implementations, 12 content-bound numerical builds, matched resources, and independent terminal gold/scoring.
- Allowed manuscript claims: non-identifiability and intervention-signature theory; accessibility deficiency; version-manifest insufficiency; the exact minimum-information/custody requirements for a valid capability-origin and numerical-identity study.
- Not established: failure-cause accuracy, compute substitution, capability-frontier shift, numerical terminal-flip prediction, scaling laws, or external superiority.
- Writing action: do not report zero performance for zero executed cells. Treat the packet as a content-bound acquisition result and preserve the numerical-outcome-identity study as a separately executable successor.
