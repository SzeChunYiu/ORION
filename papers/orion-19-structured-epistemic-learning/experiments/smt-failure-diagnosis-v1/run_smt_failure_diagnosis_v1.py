...
BUDGET_MS = 5000
LOW_FRACTION = 0.2          # compute-starved budget = 20% of the reference's own time
SPLIT_SEED = 20260830
...
def main():
    ...
    out["terminal"]=term
    json.dump(out,open(os.path.expanduser("~/o19_RESULTS_V1.json"),"w"),indent=1,sort_keys=True)
