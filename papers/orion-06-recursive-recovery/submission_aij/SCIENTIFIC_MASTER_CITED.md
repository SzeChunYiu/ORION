...
### Preregistration/provenance/negative results
...
## Research-state and successor model
...
## Frozen denominator and machine-readable graph
...
## Recovery chain I: common-anchor closure to split counterexample
...
## Recovery chain II: the repair is also refuted
...
## Finite positive to all-`n` theorem
...
## Prospective confirmation followed by later refutation
...
## Donor absorption as a successful research terminal
