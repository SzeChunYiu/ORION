...
The ORION-Q case study demonstrates the discipline through repeated donor absorptions and refutations that eventually terminate in an all-`n` theorem rather than an inflated novelty claim.

## Closest/current literature threats

### Provenance is now an explicit autonomous-science priority
...
### End-to-end AI science is already demonstrated
...
> Provenance is necessary but not sufficient. ORION-Q studies the layer above provenance: what an auditable research programme should *do next* after a prospectively evaluated hypothesis fails. We formalize negative, absorbed, mixed and saturated terminals; require donor-first novelty subtraction; freeze successor tests before outcome; and preserve every failed hypothesis while permitting bounded recovery. In one complete quantum-computing programme, this discipline repeatedly prevented false novelty and converted a sequence of exact negatives/refutations into a sharp all-size theorem.

This is meaningfully narrower than “trustworthy autonomous science” and better differentiated from the current literature.
...
- ideally one empirical/computational science programme.

Primary measurements should include:

- fraction of initial claims donor-absorbed/refuted;
- number of productive successor recoveries;
- rate of false novelty avoided;
- time/evidence cost to terminal;
- whether recovery yields a theorem/validated positive versus endless hypothesis narrowing;
- baseline comparison to naive retry, ordinary agent iteration, and strongest-donor-only workflows.

Until that cross-domain study exists, `MANUSCRIPT_V2.md` should be positioned as a **fully receipted case study and executable methodology**, not a universal evaluation of autonomous research.
