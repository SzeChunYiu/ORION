# ORION-02 reproduction guide

ORION-02 is a **methodology/case-study** paper. Its numbers are sourced from the closed ORION-Q receipts; ORION-01 owns the quantum theorem claim itself.
...
- `papers/orion-06-recursive-recovery/RECEIPT_INDEX.md`
- `papers/orion-06-recursive-recovery/RECEIPT_INDEX_V2.md`
...
The load-bearing ORION-02 chronology is R6N → R6O → R6P → R6Q → R6R → R6S. The corresponding runners are under `research/extensions/orion-q/`:
