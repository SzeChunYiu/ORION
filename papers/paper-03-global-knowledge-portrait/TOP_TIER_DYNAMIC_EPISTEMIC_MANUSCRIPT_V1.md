# P3 Top-Tier Dynamic-Epistemic Manuscript V1
...
- `P3-T1`: two records are identical for responsibility `r` iff every admissible `r`-decision treats them interchangeably.
- `P3-T2`: a global portrait exists when identity, measurement, context, modality, and attribution maps satisfy compatibility.
- `P3-T3`: failed compatibility cycles make forced canonicalization destroy a target-relevant distinction or provenance edge.
- `P3-T4`: several non-isomorphic portraits may be equally valid.
- `P3-T5`: dynamic changes reopen only dependent identities and gluing constraints.

## Novelty residual

The novelty target is not generic alignment or a sheaf metaphor. It is responsibility-indexed scientific identity with executable obstruction witnesses, alternative valid portraits, dynamic transport, and scientific authority preservation.
