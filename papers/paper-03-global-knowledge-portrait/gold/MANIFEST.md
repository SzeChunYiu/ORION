...
| `OAEI_TRACK_LICENSE_MANIFEST_V1.json` (+ `.md`) | ✓ FROZEN | OAEI/SemTab licence + selection record, pre-download (Issue #1086 P3 box 1) |
...
| `protocol/OAEI_MULTI_CASE_ANALYSIS_FREEZE_V1.json` (+ `.md`) | ✓ Frozen — pre-execution analysis contract (Issue #1086 P3 boxes 2-5) |
