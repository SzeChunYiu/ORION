...
Canonical executable result remains repository-level at:
...
- eight material corruptions are detected;
- simple transcript/action-overlap comparator resolves only two of six labels;
- explicit source-insufficient case remains `UNRESOLVED` rather than being forced into a merge/non-merge label.
