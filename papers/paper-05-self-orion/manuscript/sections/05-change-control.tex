...
The strongest internally representable successful outcome is therefore a recommendation such as \texttt{RECOMMEND\_HOST\_PROMOTION}, not ``self-merged'' or ``governed by self declaration.'' This is a structural authority boundary: even a perfect candidate score cannot compensate for missing or compromised change-control evidence.
