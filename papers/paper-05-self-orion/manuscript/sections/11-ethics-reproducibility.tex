...
\idt{protocol/P5_RESIDUAL_DISCRIMINATOR_SUCCESSORS_V1.json}. Both record that
outcomes have not been accessed and that external identities remain unbound.
They do not modify the original preregistration or turn the diagnostic errors
