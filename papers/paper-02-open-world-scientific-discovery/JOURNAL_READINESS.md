...
**Completed result-bearing evidence:** frozen 20-task offline complete-gold companion, 14 systems × 3 repeat seeds = 840 normalized run records, authority `DESCRIPTIVE_ONLY`. Full ORION mean recall 0.994444; strongest frozen confirmatory comparator 0.666667; descriptive difference +0.327777. The external Wide/Deep/MetaSyn/SAGE campaign is not complete, so this result cannot be promoted to real-web superiority.
...
- [ ] AutoResearchBench **Wide Research** official ORION-vs-baseline result — evaluator is credential-free/runnable, but no candidate result is archived yet.
...
- [ ] MetaSyn retrieval + screening result — code/data and scorer path audited, but no end-to-end result archived.
...
- [ ] publication-complete route-stop FP **and** FN table (current evaluator exposes the safety FP side used by this campaign; full paired FP/FN publication remains open).
...
- [ ] scripts regenerate **all final external metrics/plots** — external campaign/plots remain outstanding.
