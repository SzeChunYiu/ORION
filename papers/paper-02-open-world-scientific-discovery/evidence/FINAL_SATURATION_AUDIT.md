...
the PDF binary is not yet present in `journal_package`, so #490 still requires binary
rebind, checksum regeneration including that binary, and final P2 manuscript plus
repository/package CI. External ORION superiority remains `CANNOT_CHECK`.
