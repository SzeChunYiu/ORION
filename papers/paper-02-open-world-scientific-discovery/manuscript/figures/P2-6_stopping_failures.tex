...
\fill[black!65] (0,5) rectangle (12,5.36);
\node[anchor=west] at (16.88,5.18) {12};
\node[anchor=east] at (-0.35,6.18) {Coverage authority};
\fill[black!65] (0,6) rectangle (390,6.36);
\node[anchor=west] at (394.88,6.18) {390};
\node[anchor=west,font=\small] at (0,7.0) {390 frozen tasks; achieved precision TIER\_B\_committed};
\end{tikzpicture}
