# JAR submission checklist — Paper D

- [x] Abstract is 150–250 words; six keywords are present.
- [x] Formal claims and implementation claims are separated.
- [x] JSON structural and semantic validation contracts agree.
...
- [ ] Approve a truthful generative-tool disclosure; do not assert human verification before it occurs.
- [ ] Confirm all authors approve and there is no concurrent submission.
- [ ] Reconfirm current Springer source template and upload all editable files.
