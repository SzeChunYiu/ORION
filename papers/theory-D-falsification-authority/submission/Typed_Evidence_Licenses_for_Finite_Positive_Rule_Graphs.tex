...
nonempty rule transfer into an unrefuted rule head. It is \emph{fair} if
every rule that remains enabled is eventually fired.
...
No license or evidence object transfers between manuscript namespaces.
