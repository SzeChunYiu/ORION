...
A decentralized donor product supplied with the exact same scientific type, narrowing, blocker, support-family, coercion, and composition rules agrees extensionally with this paper. The contribution is therefore the explicit common scientific-discharge calculus, not centralized expressive power.
