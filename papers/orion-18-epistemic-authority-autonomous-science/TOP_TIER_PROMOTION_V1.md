# ORION-18 top-tier promotion V1 — Scientific Authorization Beyond Action Authorization
...
The August 2026 nearest-work delta donor-owns modern per-action authorization, evidence, freshness and delegation machinery. ORION-18's residual claim is therefore the higher scientific-discharge layer, not those donor mechanisms.
...
Within-scientific-assertion authority — content-bound evidence, protected-evaluator identity and the five within-domain promotion gates dispositioned `MERGE_EXISTING` in the `P1_P5_OWNERSHIP_MATRIX_V1` — is frozen upstream donor semantics owned by ORION-14 (per `papers/SYNC_CONTRACT.md`). ORION-18's residual is the cross-domain typed coercion calculus and authority-laundering composition only. ORION-25 SEI receipts are admissible here as an execution-evidence substrate (evidence plumbing) with their dispositions imported as frozen inputs; ORION-25 corpus outcomes must not be counted as ORION-18's own protected evidence.
...
- generic donor product augmented with an equivalent obligation type ties ORION-18;
- ORION-18 only renames policy attributes;
- ORION-18 gains vanish after exact source/scope/epoch metadata is given to baseline;
- ORION-18 blocks all uncertain commitments and wins by abstention;
- scientific evaluator is generated by the same system seeking authorization;
- ORION-18 re-owns ORION-14 content-bound evidence or generic authorization mechanisms;
...
- [ ] final ORION-14/ORION-16/ORION-17 ownership review at manuscript scope;
...
If the strongest donor product becomes semantically equivalent after adding scientific-obligation typing, report ORION-18 as a unifying formalization/equivalence result rather than claiming empirical superiority.
