#!/usr/bin/env python3
"""ORION02.FIBRE_DIAMETER_FLOOR.v1 -- exhaustive counterexample search.
...
def main() -> int:
    ...
    print(json.dumps({
        "schema": "ORION.ORION02.FibreDiameterFloor.Result.v1",
        "protocol_identity": "ORION02.FIBRE_DIAMETER_FLOOR.v1",
