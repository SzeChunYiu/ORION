#!/usr/bin/env python3
"""ORION02.REFINEMENT_TO_CERTIFIABILITY.v1 -- exhaustive counterexample search.
...
def main() -> int:
    ...
    print(json.dumps({
        "schema": "ORION.ORION02.RefinementToCertifiability.Result.v1",
        "protocol_identity": "ORION02.REFINEMENT_TO_CERTIFIABILITY.v1",
