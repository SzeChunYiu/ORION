#!/usr/bin/env python3
"""ORION-02: is the validity-utility frontier fundamental, or selector-limited?

Recomputes everything from the committed R24 held-out records. Validates its own
...
ARM_SET = "R24_ARM_CONDITIONAL_BOUNDARY_FIBRES"
SEED = 20260828
...
def main(path):
    ...
    print(json.dumps({
        "schema": "orion.orion02.selector-limited-certification.v1",
