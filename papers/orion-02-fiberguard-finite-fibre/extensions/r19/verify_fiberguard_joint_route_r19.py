#!/usr/bin/env python3
"""Deterministic finite audit for the FiberGuard R19 joint-route repair."""
...
from fiberguard_joint_route_r19_core import (
    bayes_value,
    deterministic_value,
...
SCHEMA = "ORION.FiberGuard.JointRoute.R19.v1"
SOURCE_BASE_COMMIT = "f34b61e0051289588eaf144a580dca7bc9b7e707"
SEED = 20260827
TERMINAL = "FIBERGUARD_JOINT_ROUTE_R19_REPLACEMENT_PASS"
...
def build_result(script_path: Path) -> dict[str, Any]:
    core_path = script_path.with_name("fiberguard_joint_route_r19_core.py")
    return {
        "schema": SCHEMA,
        "terminal": TERMINAL,
        ...
        "invalid_R19_pairing_counterexample": invalid_pairing_counterexample(),
        ...
        "authority": {
            ...
            "replaces_invalid_R19_shortcut": True,
