...
**Scientific authority delta during publication closure:** `NONE`
...
| V3-E7 | The R24 lexical control had 14 aggregate strict violations versus 20 for the primary arm, but the result object did not serialize per-instance policy-arm violation flags. | **`CANNOT_CHECK` COMPARATOR MARGIN** | No paired comparative test can be reconstructed. Do not claim that either arm is superior from the aggregate counts. |
...
| V3-X4 | Comparative superiority of the R23 geometry or either R24 arm. | **NOT ESTABLISHED / FORBIDDEN** | A valid paired analysis from retained per-instance paired outcomes; R24 currently remains `CANNOT_CHECK`. |
