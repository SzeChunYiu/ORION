...
The strongest committed study, R24, evaluated 44 held-out decisions. Its arm-conditional construction reached `44/44` coverage, but strict held-out violations were `20/44 = 0.455`, against a registered maximum of `0.10`. A matched no-geometry lexical control also reached `44/44` coverage, so the registered geometry supplied no measured advantage on that corpus. The R24 terminal remains `C_R24_ARM_CONDITIONAL_CERTIFICATE_INVALID`.
