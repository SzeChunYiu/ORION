#!/usr/bin/env python3
"""Reconstruct the frozen R24 paired strict-violation comparator fail-closed."""
...
GEOMETRY = "R24_ARM_CONDITIONAL_BOUNDARY_FIBRES"
CONTROL = "R24_LEXICAL_GOOD_BOUNDARY_NEGATIVE_CONTROL"
CONTROL_SUMMARY = "R24_LEXICAL_MATCHED_PRIMARY"
EXPECTED_TERMINAL = "C_R24_ARM_CONDITIONAL_CERTIFICATE_INVALID"
...
def reconstruct(result: dict[str, Any], *, source_sha256: str) -> dict[str, Any]:
    require(result.get("terminal") == EXPECTED_TERMINAL, "R24 terminal drift")
    ...
    return {
        "schema": "ORION.ORION02.R24StrictViolationComparatorCorrection.v1",
        "source": {
