...
**Dynamic State–Reasoning Co-Design: Vector-Budget Metareasoning under Censoring, Drift, and Nonstationary Prices**
...
- Authoritative result SHA: `f1a2bc3c636ef618fb72073472a0ed1231be1634`.
- Exact terminal: `CANNOT_CHECK_PROTECTED_SUBSTRATE_AND_NONFLAT_SUCCESSOR_NOT_RUN`.
- Frozen corpus: 102 official instances, six license-excluded cases, 96 clean-license cases, four domains, 24 task families, and three FLAT arms.
- Executed scientific outcomes: zero; no Slurm jobs submitted; exact model, repeat, and run-cell denominators remained unfrozen.
- Flat stop/go terminal: `CANNOT_CHECK_PROTECTED_SUBSTRATE_NOT_RUN`.
- Non-FLAT successor terminal: `CANNOT_CHECK_NONFLAT_SUCCESSOR_NOT_FRESHLY_FROZEN`.
- Allowed manuscript claims: signal non-identifiability, non-degeneracy requirements, censoring theory, coarsened-signal regret, and the exact stop/go and successor-identity boundaries.
- Not established: task gain, regret improvement, cost advantage, domain stability, signal contribution, action diversity, price robustness, shift robustness, model generalization, or top-tier readiness.
- Writing action: retain the current FLAT design as a non-executed stop/go protocol and require a separately named, prospectively frozen non-FLAT successor. Do not infer incapability from absent substrate execution.
