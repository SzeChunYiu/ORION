...
| `orion_live_provider` | BASELINE | MISSED_REFRAME | 98 | 21 | 0.6364 | `P1-C-14aefdd887`, `P1-C-2a87cda138`, `P1-C-3dba4ee7db` |
| `orion_live_provider` | BASELINE | CANNOT_CHECK | 86 | 23 | 0.5584 | `P1-C-39818be118`, `P1-C-3dba4ee7db`, `P1-C-43c471c226` |
...
| `orion_live_provider` | BASELINE | WRONG_RESPONSIBILITY | 56 | 12 | 0.3636 | `P1-C-239f672ebc`, `P1-C-8b5889326e`, `P1-C-8f17134405` |
...
|---|---|---|---|---|
| ABSTENTION | 2345 | 11 | 0.8393 | `P1-C-14aefdd887`, `P1-C-239f672ebc`, `P1-C-39818be118` |
| WRONG_RESPONSIBILITY | 241 | 4 | 0.0863 | `P1-C-239f672ebc`, `P1-C-43c471c226`, `P1-C-44d2443b8b` |
| MISSED_REFRAME | 153 | 12 | 0.0548 | `P1-C-14aefdd887`, `P1-C-2a87cda138`, `P1-C-3dba4ee7db` |
| CANNOT_CHECK | 86 | 1 | 0.0308 | `P1-C-39818be118`, `P1-C-3dba4ee7db`, `P1-C-43c471c226` |
| UNNECESSARY_REFRAME | 45 | 3 | 0.0161 | `P1-C-8b5889326e`, `P1-C-9fbf65695c`, `P1-C-e2cb3aa558` |
| INCOMPLETE_REOPEN | 10 | 1 | 0.0036 | `P1-C-557ed886fe`, `P1-C-ffb30e12b4` |
