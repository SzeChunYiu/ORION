...
The achieved precision tier is \AchievedTier{} with half-width
\AchievedHalfWidth{}. The number of cases required for the primary hypothesis is
\RequiredNForHOne{}, and for the restraint hypothesis \RequiredNForHTwo{}. The
study is therefore underpowered for its primary hypothesis, with
\StochasticRepeats{} stochastic repeats per case.
...
restraint hypothesis. The achieved tier \AchievedTier{} is below the minimum
standard, so this study remains underpowered for its broad primary hypotheses.
