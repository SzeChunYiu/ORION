...
present in `journal_package`, so #489 still requires binary rebind, checksum regeneration
including that binary, and final repository/package CI. The P1 scientific claim ceiling
is unchanged.
