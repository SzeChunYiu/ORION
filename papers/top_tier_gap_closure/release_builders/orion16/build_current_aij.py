...
AUTHOR_NEW = r'\author{Sze Chun Yiu\\Stockholm University, Stockholm, Sweden\\\texttt{sze-chun.yiu@fysik.su.se}}'
...
def main():
    ...
    for token in ('Sze Chun Yiu','Stockholm University, Stockholm, Sweden','1,536 states','96 typed-erasure separation witnesses','zero ideal-product mismatches','The author received no specific funding','The author declares no competing interests','Declaration of generative AI'):
