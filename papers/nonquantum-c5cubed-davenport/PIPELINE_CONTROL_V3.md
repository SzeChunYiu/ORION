# Non-quantum paper sealed pipeline control V3
...
- Proof parents: M1–M3 signed protocols and generic/dual records under
  `development/orion-rg-davenport/`; later X1 records remain supporting history.
...
No quantum-paper evidence is admissible in this namespace.
...
Use one table separating theorem-grade exclusions from bounded computation and
one phase diagram in prose/table form. The abstract must state what is proved,
what is conditional, and what remains open. Repository or certificate paths
belong only in data/code availability, not in the theorem narrative.
