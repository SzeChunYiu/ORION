# Scientific Certificate Lifting for Dynamic Scientific Computation

**Paper VI current science manuscript overlay — V4**  
**Date:** 2026-08-20  
...
**Science terminal:** `P6_CERTIFICATE_LIFTING_SEMANTICS_SUPPORTED__BOUNDED_FORMAL_DONOR_STACK__IDEAL_PRODUCT_EQUIVALENT`

V4 preserves the V2.1/V3 theorems and elevates their constructive consequence: scientifically governed systems can retain strong operational certificates across change and revalidate only the scientific bridge that was actually affected.
...
- **Proof-carrying action systems** contribute action identity, approval binding, runtime/outcome receipts, and portable authorization evidence.
...
The five coordinates are a registered theorem instance, not a claim that all scientific domains must use exactly this ontology. A donor that already carries an equivalent coordinate and bridge rule is enriched directly into the equivalent side of the calculus.
...
Operational validity can therefore survive a material scientific change even when continuity of the old scientific standing does not. The distinction localizes what must be re-established instead of invalidating the entire operational record.

### Theorem V4.3 — certificate-product non-laundering
A product of native-valid donor certificates cannot infer an absent scientific lift coordinate without an explicit bridge rule. Execution success, replay fidelity, provenance completeness, workflow validity, and attestation can accumulate as useful assurance while leaving a claim-specific measurement or inference obligation unresolved.
...
A second implementation reconstructs the enumeration without importing the primary checker.
