...
# Committed v2.2.4 primary rates (hidden-shift protected_root_task_success,
# forbidden_high_level_mutation_rate) -- the reproduction gate.
COMMITTED = {
...
def main() -> int:
    ...
    gate_rows = []
    gate_pass = True
    for name, (exp_s, exp_f) in COMMITTED.items():
    ...
    result: dict[str, Any] = {
        ...
        "anchor_reproduction_gate": {"passed": gate_pass, "rows": gate_rows},
