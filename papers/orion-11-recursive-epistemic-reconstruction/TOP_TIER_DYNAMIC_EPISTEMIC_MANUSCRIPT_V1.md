...
Absorb model-based debugging, causal diagnosis, abductive reasoning, scientific problem reformulation, value-of-information, and safe self-improvement. Novelty survives only if the integrated system identifies responsibility and minimum repair more efficiently than their ideal donor product. An information-equivalent donor must tie.
