...
1. **The obstruction is non-vacuous in practice.** 46 hybrid tasks arise out of 1,962
   real X.509 trust-store merge tasks (~2.3 %). The phenomenon the theory describes
   actually occurs in deployed certificate material; it is not a synthetic curiosity.
