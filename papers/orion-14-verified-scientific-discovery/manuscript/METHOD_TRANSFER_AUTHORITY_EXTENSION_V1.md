# ORION-14 additive manuscript bridge — authority for transferred and machine-generated methods

**Status:** additive extension for #410/#412. The citation-saturated peer-review-ready ORION-14 manuscript/PDF and protected V2 campaign remain immutable historical publication authority. This text is the canonical successor-manuscript bridge; it does not rewrite the existing ORION-14 headline result.

## Authority for transferred and machine-generated methods

A method proposal can be structurally plausible, empirically useful, and even mathematically valid in one setting without earning every scientific claim that researchers may wish to attach to it. ORION-14 therefore extends its non-escalating authority rule from claim/evidence verification to a method-specific coordinate product.
...
The receipt itself grants no authority. ORION-14 derives independent coordinates:
...
- **ADOPTION** — may Self-ORION incorporate it? ORION-14 never grants this coordinate; it remains ORION-15/host-governance owned.
...
**Useful known donor.** A transferred method preserves its assumptions, reconstruction and protected result, but the current novelty search identifies prior art. ORION-14 permits the bounded validity/transfer/utility claim while blocking novelty. The prior-art finding does not erase the useful scientific result.
...
The coordinate-product policy is compared with three deliberately diagnostic policies: visible-success promotion, provenance-only promotion, and all-deny refusal. The frozen summary records zero false promotions with full clean promotion coverage for the ORION-14 coordinate product. Visible-success and provenance-only policies promote all seven negative/blocked cases; all-deny avoids false promotion but rejects every clean case. This is a closed-world anti-laundering discriminator, not external evidence that ORION-14 can determine real-world method novelty or scientific importance.

## Nonclaims and ownership

This extension does not claim that ORION-19 learns useful structures or that ORION-20 invents good methods. ORION-12/ORION-17 may discover candidate routes; ORION-13/ORION-16 own structural mapping/equivalence; ORION-18 owns the broader typed cross-capability authority calculus; external novelty review remains required for real novelty claims; ORION-15/host governance owns adoption. The existing protected V2 ORION-14 paper remains exactly as published in its current peer-review-ready package.
