...
V0 proves this lifecycle can be executed once on a live quantum-compilation question. It does not estimate calibration or predictive value.
...
3. independent heterogeneous decision instruments;
4. disagreement/cannot-check preserved rather than forced to consensus;
5. a scorer rule frozen before outcome evidence;
6. later evidence bound to the original item/decision rather than a rewritten task;
7. explicit invalidation when the original item/scorer contract was defective.

Searches should use neighboring terms including longitudinal forecasting, delayed-label evaluation, prequential evaluation, scientific decision support, agent confidence/calibration, multi-agent agreement, research provenance and benchmark item invalidation.
