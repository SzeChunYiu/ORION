...
The systems contribution is intentionally out of scope. Receipt publication, bounded outputs, process safety, recovery semantics, and the relationship between the two harnesses as execution systems all require their own donor matrix and protocol, and are not evaluated here. This paper uses those mechanisms only to make the agreement measurement auditable.