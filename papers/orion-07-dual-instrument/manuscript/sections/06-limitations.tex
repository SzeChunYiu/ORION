...
The decisive limitation is sample size: V0 is one frontier question. No reliability, agreement-rate, predictive-validity, or calibration claim follows. This is also a publication blocker under the prospectively recorded Q3 plan, which requires at least two to three additional instances.
...
Finally, reproducible receipts do not make a decision scientifically correct. They make the evidence/decision path attributable. P15's systems guarantees and Q2's methodological claims are therefore distinct from Q3's benchmark interpretation.