# Paper ORION-03 claim ledger V1

**Manuscript:** `papers/archive/2026-08-pre-unification/Q-paper-03-dual-instrument/MANUSCRIPT_V1.md`
**Branch:** `claude/orion-harness-verification-b17qdj`
**Date:** 2026-08-21

Format follows the repository's paper claim-ledger convention (cf.
`papers/orion-14-verified-scientific-discovery/CLAIM_LEDGER_V3.md`): each row states the
...
- Any claim about the quantum-mechanical content of the R6 chain (owned by Papers ORION-01/ORION-02
  per `papers/orion-06-recursive-recovery/PUBLICATION_PLAN.md`).

## Open obligations before submission

1. Run 2–3 further benchmark question instances to seed the agreement series
   (`PUBLICATION_PLAN.md` Paper ORION-03 gate; coordinate-4 scoring gate already satisfied).
