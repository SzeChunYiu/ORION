...
The systems contribution is intentionally out of scope. P15 is the place to evaluate receipt publication, bounded outputs, process safety, recovery semantics, and the relationship between the two harnesses as execution systems. Q3 uses those mechanisms only to make the agreement measurement auditable.