...
`Structural predicate' always means predicate in a declared feature vocabulary. QG-15b proves non-separability only inside its frozen StabPrep vocabulary; richer path/schedule-aware features may recover exact determination. Likewise, TARE's current finite trade vocabulary is not yet proved all-$n$ complete.
