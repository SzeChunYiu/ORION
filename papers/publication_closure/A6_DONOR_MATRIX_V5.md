...
for the hyperintensional row, whose primary sources are `CANNOT_CHECK` here.
...
hyperintensional row is explicitly marked `CANNOT_CHECK` rather than dressed in
