...
SPECS = [
    ...
    spec("ORION-08", "orion-08-typed-state", "Typed Epistemic State under Partial Knowledge: Six Matched-Information Mechanism Studies", "Transactions on Machine Learning Research", "double_blind", "cs.AI", "CLAIM_LEDGER_V3.md", "READY_TO_SUBMIT_SECOND_TIER__EXACT_SYNTHETIC_SCOPE", "Six separately frozen exact-synthetic families isolate how typed scope, transport, verification, laundering checks, and decision coupling affect downstream choices under matched visible information.", ["Scoped versus never-reopen intervals cross zero in both N4-B regimes, and the remint-unnecessary N4-F3 regime is an exact tie.", "No real LLM or scientific-agent transfer, security guarantee, minimal-schema theorem, or real-domain generalization is claimed."], crosslists=["cs.LG"]),
