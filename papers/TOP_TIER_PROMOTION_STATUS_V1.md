# P6–P15 top-tier promotion status V1

**Owner issue:** #977  
**Draft PR:** #978  
**Date:** 2026-08-23

This status record distinguishes implemented promotion contracts, newly earned bounded scientific objects, authoritative negatives, and still-unearned broad external authority.

| Paper | Earned state after protected execution | Higher target | Current top-tier state |
|---|---|---|---|
| P6 | bounded ETS separation; three finite transition families; same-facts donor comparator; byte replay | Epistemic Transition Systems across real transition systems | `BOUNDED_ETS_SEPARATION_EARNED__REAL_SYSTEM_PROMOTION_PENDING` |
...
| P10 | exact formal OCME non-vacuity: 2 obstruction families, 2 hand-declared outside-closure edit types, 6 held-out transfers, 0 false expansions | generated/non-hand-coded OCME under donor-complete native verified solving | `BOUNDED_OCME_OBJECT_EARNED__BROAD_EXTERNAL_PROMOTION_PENDING` |
| P11 | bounded query/optionality theory + learned non-oracle compiler positive on wine/digits, breast-cancer negative | computational placement + optionality law with full end-to-end accounting and cross-domain replication | `EXTERNAL_PROMOTION_PENDING` |
...
- programme-wide donor-first/upward-generalization constitution;
- one maximum-claim promotion protocol per P6–P15;
- explicit donor-complete comparator requirements and shared resource-accounting ontology;
- protected evidence and independent-authority gates;
...
- **P6:** real donor-complete transition-system replications and stronger independent theorem/checker authority;
...
- **P10:** at least one generated/non-hand-coded outside-closure edit, donor-complete native search/repair/synthesis/evolutionary comparators, qualifying verifier-backed settings and independent implementation;
- **P11:** no-answer-laundering closure, stronger decoder attacks, full end-to-end compiler accounting, qualifying real-system/cross-domain replication and prospective phase prediction;
