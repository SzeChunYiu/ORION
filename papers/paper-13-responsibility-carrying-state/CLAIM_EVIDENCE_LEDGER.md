...
| RCS has zero unsafe reuse in P13A | **SUPPORTED / PRIMARY** | 12,288 protected episodes | controlled held-out families |
...
| RCS has deterministic two-run replay | SUPPORTED | SHA `ea400698…e6e8d1f` | exact protected payload |
| responsibility-carrying state eliminates unsafe reuse while avoiding always-reopen cost in the controlled benchmark | **SUPPORTED SYNTHESIS** | P13A | strongest current paper claim |
