# ORION-10 - certified cost forecasts and refutable regime maps
...
ORION-09's regime-geometry and state-preparation evidence is fully absorbed into this manuscript. ORION-09 has no independent submission route; its old PDFs and packages are provenance only.

The filing package contains distinct attributed arXiv and Quantum PDFs and sources, the attributed Supplementary Information, a bounded verifier/receipt artifact, route metadata, claim and result-retention ledgers, hostile review, checksums and clean-build verification. It makes no production-compiler, runtime, hardware, quantum-advantage, reweighted-objective or broad-transfer claim.
