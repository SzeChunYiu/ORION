# ORION-10 — Theorem-backed static forecasting

**Stable ID:** ORION-QG-ORION-12  
**Canonical manuscript:** `manuscript/main.tex`  
**Status:** `INTERNAL_REVIEW_PASS__LAYERED_CERTIFICATE_CLAIM / SUBMISSION_GATES_OPEN`

## One job

ORION-10 studies how to forecast an exact TARE structural cost without invoking the unrestricted dynamic-programming referee, while keeping separate certificates for **cost exactness**, **regime explanation**, and **empirical validation**.
