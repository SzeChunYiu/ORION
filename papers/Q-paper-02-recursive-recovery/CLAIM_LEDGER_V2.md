...
|---|---|---|---|
| Q2V2-C1 | The ORION-Q programme instantiated a prospectively frozen negative-recovery workflow with typed honest terminals, donor first refusal, and retained negative history. | Frozen protocols + result/closure records | One programme/repository; implementation demonstration, not comparative superiority. |
| Q2V2-C2 | The workflow produced all four relevant terminal behaviors in practice: donor absorption, bounded positive, exact refutation, and honest negative/cannot-check. | R6 and N1--N4 receipts | Descriptive case-study claim only. |
...
No `first` claim is authorized until the submission-date literature pass. No statistical claim is made that this workflow outperforms alternative research methodologies. Receipt coverage is not evidence quality. The method does not imply that all negatives should be reopened or that every residual is novel.