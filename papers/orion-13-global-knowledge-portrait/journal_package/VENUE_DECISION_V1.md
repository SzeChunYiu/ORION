...
**Status:** `PRIMARY_SELECTED / SUBMISSION_NOT_YET_AUTHORIZED`

## Primary — Semantic Web Journal

**Disposition:** `PRIMARY` for the bounded projection-to-mapping / obstruction paper.
...
Current submission mechanics recorded from the official author/FAQ pages:

- submit a single PDF including tables/figures;
- identify the paper category in the cover letter;
- no strict page limit, with the journal advising that papers generally remain below about 25 pages excluding references;
- current APC for papers submitted from 1 September 2024 onward is US $2,100, subject to institutional/open-access agreements;
- evaluation resources should be frozen at a long-term stable URL and should not silently change during a review phase.
...
- `https://www.sciencedirect.com/journal/journal-of-web-semantics/publish/guide-for-authors`
...
## Submission-specific gates created by this decision
