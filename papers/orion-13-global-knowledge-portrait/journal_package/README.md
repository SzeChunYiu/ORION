...
The retained `journal_package/manuscript.pdf` is a historical 20-page scoped
package. The tracked working manuscript now renders 45 pages.
...
Issue #283 owns `ScientificResultVerification.v1`. Integrity checks and internal
execution do not create current package, novelty, or external-review authority.
