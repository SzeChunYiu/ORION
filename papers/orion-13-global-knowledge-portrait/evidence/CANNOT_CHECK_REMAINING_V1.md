# ORION-13 remaining `CANNOT_CHECK` — V1 journal-readiness closeout

**Date:** 2026-08-17  
**Issue:** #100  
**Rule:** an LLM cannot become gold. Missing expert labels are recorded, not filled.

## Expert gold (original `ORION-13.cross-domain-atlas.v1`)
...
| Promote `gold/adjudicated/ORION-13.*.gold.json` to expert gold | **forbidden** | annotator_id is `seed-to-gold-v1` |
...
|---|---|---|
| [32048771229](https://github.com/SzeChunYiu/ORION/actions/runs/32048771229) | ORION-13 public-reference atlas | non-fast-forward push to PR branch |
| [32048685335](https://github.com/SzeChunYiu/ORION/actions/runs/32048685335) | ORION-13 public-reference atlas | same class |
...
- **ORION-13.C7** raw-text end-to-end integration vs model/RAG/schema baselines
- **ORION-13.C8** downstream scientific answer quality
- **ORION-13.C6** necessity of every coordinate (partial: obstruction/modality supported; referent/construct/measurement/temporal unidentified on current coverage)
