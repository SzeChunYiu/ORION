...
**Theorem 1 (simultaneous alphabet ceiling).** Every admitted instance has an exact optimum \(x^\star\) such that, simultaneously for every constrained generator \(R\),
