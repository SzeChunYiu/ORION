# ORION-01 canonical journal science designation V4

**Date:** 2026-09-01  
**Scientific authority delta:** integration and correction only; no new science and no widened claim.

## Single live submission surface

ORION-01 is one paper. Its only live manuscript and claim ledger are:
...
V4 joins the two previously separated components into one argument. The first component establishes the whole-instance deletion contract, binary generated-span ceiling, exact Restore sensitivity, and matched-family equality `beta=kappa=2`. The second defines the operational rank-only calculus and shows the dependent-triple separation `beta=5`, `kappa=1` using the same joint active-column statistic on both sides. Product arithmetic is retained only as a declared-model corollary.
