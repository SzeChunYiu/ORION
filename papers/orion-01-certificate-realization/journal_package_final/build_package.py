...
SKILL_REVISION = "8d5d314009b79039ac77dd297df8439e1aac63b2"
...
CONFIG = {
    "paper": "ORION-01",
    "canonical": "MANUSCRIPT_V4.md",
    "ledger": "CLAIM_LEDGER_V4.md",
    "stem": "Restore-Sensitive_Certificate_Realization",
}
...
def copy_common_ancillary(ancillary: Path) -> None:
    ...
    component_a = PAPER_ROOT / "journal_package_A_final" / "submission" / "anc"
    component_b = PAPER_ROOT / "journal_package_B_final" / "submission" / "anc"
    shutil.copy2(component_a / "finite_records.json", ancillary / "finite_records.json")
    for name in ("certificate_control_records.json", "verify_dependent_triple_lemmas.py"):
        shutil.copy2(component_b / name, ancillary / name)
...
def build() -> None:
    ...
    manifest = {
        ...
        "scientific_authority_delta": "NONE__LEGACY_COMPONENT_INTEGRATION_AND_EDITORIAL_PACKAGE_CLOSURE_ONLY",
