...
`P12-DES-01`: finish the current real-substrate stop/go unchanged, then run a separately frozen non-FLAT multi-model/domain successor. Endpoints: task gain, regret, cost, domain consistency, censoring, action diversity, and signal contribution. Intended terminal: `VECTOR_BUDGET_STATE_REASONING_CODESIGN_SURVIVES_CENSORING_PRICE_AND_DOMAIN_SHIFT`.
