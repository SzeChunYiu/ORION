...
A new nearest work does not cause ORION to hide the overlapping mechanism. The mechanism is donor-owned, absorbed into the comparator/envelope, and the protected discriminator moves upward.
...
F. Y. Wang and M. J. Buehler, arXiv:2606.01444, submitted 2026-05-31.

Current public summaries explicitly model scientific discovery as a verified regime transition between schema categories, with provenance-preserving transport via left Kan extension and residual content beyond functorial transport.
...
1. **Agent Action Decision Protocol (AADP)**, Internet-Draft `draft-saha-aadp-00`, 2026-08-17: per-action authorization with machine-readable reasons, fail-closed obligations, budget reservation, evidence requirements and execution invariants.
2. **Security Principal and Verifier Binding for Agent Communication Protocols**, `draft-bu-agentproto-security-principal-binding-06`, 2026-08-17: separates identity, authority, delegation, action evidence, verifiers and freshness/failure rules rather than collapsing them into one token.
3. **Agent Authorization Envelope (AAE)**, `draft-kroehl-agentic-trust-aae-01`, 2026-08-11: machine-evaluable mandate/constraint/time-bounded authorization container.
4. **Succession Receipts**, `draft-sabey-succession-receipts-02`, 2026-07-21: signed evidence of authority transfer with carried obligations and offline verification.
5. NIST's 2026 AI Agent Standards/Identity and Authorization programme: identity, authorization, auditing, non-repudiation and evolving agent controls are explicit standards targets.
...
- https://nic.csc.fi/pub/files/index/internet-drafts/draft-bu-agentproto-security-principal-binding-06.html
- https://nic.csc.fi/pub/files/index/internet-drafts/draft-kroehl-agentic-trust-aae-01.html
- https://www.nic.funet.fi/index/internet-drafts/draft-sabey-succession-receipts-02.html
...
J. Kim and S. Lee, UAI 2026, PMLR 337:3101–3116, published 2026-08-21 proceedings window.

The paper extracts task readout subspaces from frozen LLM hidden representations across 50 models and reports that benchmark/task identity strongly structures the accessible readout subspace, while probe accuracy can exceed generation accuracy.
