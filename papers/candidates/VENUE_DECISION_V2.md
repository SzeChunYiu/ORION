...
Do not pitch as a new programming language or generic formal-methods system.

### Fallback: Journal of Artificial Intelligence Research (JAIR)
...
Submission framing:
> A formal agent-governance paper about the interface between generic authorization and target scientific-obligation discharge, with exact cross-domain typing, revocation semantics and a negative equivalence theorem blocking false centralization claims.

### Fallback: Artificial Intelligence (AIJ)

Use if the manuscript is positioned more strongly around formal knowledge/authority representation than systems governance.

## Submission exclusions

No manuscript should include an empirical-superiority sentence unless a frozen donor-product evaluation exists. The theory manuscripts are complete without such a sentence.

No venue choice changes the canonical five-paper ORION registry. Candidate promotion remains a separate repository-history decision.
