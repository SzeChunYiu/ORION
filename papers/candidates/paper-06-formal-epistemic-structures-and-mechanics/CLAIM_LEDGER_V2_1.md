...
| P6.7 | Sequential non-escalation, hard-obligation persistence, recursive-audit boundary and self-admission countermodel remain as in V2. | THEOREM / BOUNDARY | Novelty over donor authorization/effect/recursion fields. |
