...
| P7-C8 | Incomplete and target-ambiguous transport requires reopen or `CANNOT_CHECK`; incomplete but non-ambiguous transport does not imply semantic failure. | THEOREM / BOUNDARY | Thm. 6 + 64 transport combinations | “Missing transport proof proves the old result false.” |
