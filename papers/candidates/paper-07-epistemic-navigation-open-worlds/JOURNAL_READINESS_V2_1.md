...
- [ ] final literature delta immediately before submission;
- [ ] venue-template conversion/copyedit/reference normalization;
- [ ] archive exact commit/check outputs.

A later live-agent benchmark can strengthen the paper but is not required to make the formal theory complete.
