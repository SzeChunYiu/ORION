...
PROTOCOL_PATH = HERE / "MATHLIB_TRANSFER_PROTOCOL_V2.json"
MANIFEST_PATH = HERE / "MATHLIB_CORPUS_V2_MANIFEST.json"
CORPUS_ROOT = HERE / "corpus" / "mathlib4_e72c1e277f31"
RESULT_DIR = PAPER / "results"
RESULT_PATH = RESULT_DIR / "MATHLIB_TRANSFER_V2.json"
NULL_PATH = RESULT_DIR / "MATHLIB_TRANSFER_V2_NULL_DISTRIBUTIONS.json"
MARKDOWN_PATH = RESULT_DIR / "MATHLIB_TRANSFER_V2.md"
...
def null_distributions(
    ...
    distributions: dict[str, Any] = {
        "schema": "P10MathlibTransferNullDistributions.v2",
        "observed": observed,
...
def render_markdown(result: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            f"The pre-registered standalone gate **{'passes' if gate['passes'] else 'does not pass'}**. Numerical prediction condition: {gate['prediction_condition']}; every-seed/two-null order condition: {gate['null_condition']}.",
            "",
...
def main() -> None:
    ...
    result = {
        "schema": "P10MathlibTransferResult.v2",
        ...
        "null_summary": nulls,
        "standalone_gate": {
            "passes": prediction_condition and null_condition,
