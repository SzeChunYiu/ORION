# Top-tier execution ledger addendum — 2026-08-23

Status: **late same-day verification strengthening; no broad authority widening**
...
Two-checker verification:

- GitHub Actions run: `32653576016`;
- artifact: `p6-ets-v1-receipt`, artifact ID `9496839720`;
- artifact ZIP SHA-256: `fa6ec2504978d374e9a1573f92b27933820d8a484bb625375cb1d1dc2b2650d9`;
- primary terminal: `P6_ETS_BOUNDED_EXECUTABLE_POSITIVE`;
- independent terminal: `P6_ETS_SECOND_INDEPENDENT_CHECKER_GREEN`;
- primary replay: `P6_ETS_V1_BYTE_REPLAY_GREEN`;
- independent replay: `P6_ETS_INDEPENDENT_V1_BYTE_REPLAY_GREEN`;
- cross-implementation terminal: `P6_ETS_TWO_IMPLEMENTATIONS_AGREE`.

The second verifier does not import or execute the primary checker. It implements the frozen scientific-admission semantics through prioritized epistemic defect sets, remints label-like fields to attack fixture leakage, reproduces all `18/18` gold dispositions, and independently reconstructs the T6.1–T6.3 bounded invariants including the exact `47` donor-observable erasure-collision count.
...
- GitHub Actions run: `32653800366`;
- artifact: `p10-ocme-formal-v1`, artifact ID `9496899438`;
- artifact ZIP SHA-256: `8721d02a02b78c6b6f3ee7281f60f106070a462e0c84de821be34ab2dedd91fd`;
- primary terminal: `P10_OCME_FORMAL_NONVACUITY_V1_GREEN`;
- independent terminal: `P10_OCME_FORMAL_SECOND_INDEPENDENT_CHECKER_GREEN`;
- primary replay: `P10_OCME_FORMAL_V1_BYTE_REPLAY_GREEN`;
- independent replay: `P10_OCME_FORMAL_INDEPENDENT_V1_BYTE_REPLAY_GREEN`;
- cross-implementation terminal: `P10_OCME_FORMAL_TWO_IMPLEMENTATIONS_AGREE`.

The second verifier uses different closure-membership mathematics from the primary implementation:

- Boolean affine membership is rederived from GF(2) algebraic-normal-form degree rather than enumeration of all `32` affine truth tables;
- integer affine membership is rederived from exact all-triples collinearity rather than first-two-point fitting / second finite differences.

Both implementations agree on every frozen obstruction identity and known-method control, both outside-closure edit types, all `6` held-out transfers and `0` false expansions.
...
Nothing in this addendum grants `TOP_TIER_SUBMISSION_READY`. It narrows three bookkeeping gaps to the exact authority already earned by executable evidence. The remaining broad promotion conditions in the paper-local `TOP_TIER_PROMOTION_V1.md` contracts continue to govern submission authority.
