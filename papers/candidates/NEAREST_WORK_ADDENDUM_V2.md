...
C. A. R. Hoare, “An Axiomatic Basis for Computer Programming,” *Communications of the ACM* 12(10), 1969, DOI `10.1145/363235.363259`.
...
John C. Reynolds, “Separation Logic: A Logic for Shared Mutable Data Structures,” LICS 2002, DOI `10.1109/LICS.2002.1029817`.

Hans van Ditmarsch, Didier Galmiche and Marta Gawek, “An Epistemic Separation Logic with Action Models,” *Journal of Logic, Language and Information* 32, 2023, DOI `10.1007/s10849-022-09372-z`.
...
`typed requested/committed epistemic effects + non-compensatory residual obligations + content-bound provenance + footprint-faithful composition + dependency repair + protected authority roots + retained trace semantics`.
...
This targeted formal-methods pass found **no new source that collapses the exact atlas residual**, but that is not a no-prior-work certificate. The residual remains:

`partial maps between representations/objectives + support/certificate transport + obligation reopening + closure authority under censored/open regions`.
...
Moritz Becker, Cédric Fournet and Andrew D. Gordon, “SecPAL: Design and Semantics of a Decentralized Authorization Language,” *Journal of Computer Security* 18(4), 2010, 619–665.

**Donor mechanisms:** logical authorization queries, delegation, recursive policy, negation, constraints and revocation with sound/complete terminating execution under stated conditions.

### DKAL / executable authorization protocols

Yuri Gurevich and Itay Neeman, “DKAL: Distributed-Knowledge Authorization Language,” CSF 2008; and Jean-Baptiste Jeannin et al., “DKAL*: Constructing Executable Specifications of Authorization Protocols,” ESSoS 2013.

**Donor mechanisms:** knowledge/information-bearing authorization, distributed principals, quotation/delegation, operational semantics, typed executable protocol specifications and verified interpretation.

### Dynamic authorization and information flow

Owen Arden et al., “A Calculus for Flow-Limited Authorization,” arXiv:`2104.10379`.

**Donor mechanisms:** dynamic computation of authority, changing trust relationships and formal confidentiality/integrity guarantees for authorization mechanisms.

### Current agent effect systems
...
This addendum is based on publisher/official research records and abstract/mechanism verification. It is not the two-round full-text saturation required by #334/#337/#340, and it does not close #287.
