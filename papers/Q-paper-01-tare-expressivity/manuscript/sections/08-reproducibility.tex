...
Every quantitative statement is bound to committed protocols, result JSON, and generating code. The primary chain is R6N--R6S under \texttt{research/extensions/orion-q/} and \texttt{development/orion-q-max-r0/}; the current classification stress tests are QG-5b and QG-7/QG-7b/QG-7c under \texttt{research/extensions/orion-qg/} and \texttt{development/orion-qg-regime-geometry/}. The applied grounding uses the R4B and R4D receipts.
