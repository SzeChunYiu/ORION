...
| host or capability failures are kept outside scientific evidence | METHODS GUARANTEE CANDIDATE | describe the tested software contract; do not call it an empirical ORION-25 result |
...
| the two harnesses share a receipt semantics | OPEN DESIGN QUESTION | no equivalence claim until a ORION-25 protocol defines and tests it |
...
ORION-25 has no H1, protected input corpus or scientific result. Therefore it has no
...
ORION-25 has no H1, protected protocol, or scientific result. Therefore it has no
negative hypothesis to relabel and no positive hypothesis to claim. The typed
...
## Evidence correction (2026-08-24, issue #1086 ORION-23–ORION-25 lane)
...
| ORION-25 and ORION-03 form one software/instrument paper | **CONSOLIDATED D8 / EDITORIAL** (`papers/ISSUE_1086_PORTFOLIO_DISPOSITION_V1.json` decision D8) | portfolio structure only; no scientific authority delta |
