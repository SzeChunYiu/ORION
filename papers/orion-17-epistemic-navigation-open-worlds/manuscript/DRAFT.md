...
ORION-11 already owns responsibility-triggered representation/search-universe reconstruction. ORION-12 already owns earned route independence, question-framed discovery, route-versus-task stopping and fail-closed open/censored coverage. ORION-17 cannot claim either mechanism. It asks whether their interaction belongs to a broader navigation theory in which representations, world models and objectives form a family of charts connected by partial preservation maps.
