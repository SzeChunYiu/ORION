# ORION-24 external frontier delta — 2026-08-23
...
**Disposition:** ADOPT. ORION-24 does not claim novelty for hierarchical paper-replication rubrics or judging research engineering outputs.
...
**Disposition:** ADOPT. ORION-24 does not claim novelty for including negative/non-replicable science in agent evaluation or for process-level replication benchmarking.
...
**Disposition:** ADOPT. ORION-24's donor-subtraction component must be evaluated with strong research-oriented retrieval rather than weak generic search.
...
**Disposition:** ADOPT. ORION-24 cannot claim general scientific-agent benchmarking.
...
**Disposition:** ADOPT / strongest external-authority pattern. Original-author/expert blinded grading is a direct donor for the external ORION-24 adjudication design.
...
**Disposition:** ADOPT. ORION-24 must not confuse ability to generate/execute research with the governance question.
...
ORION-24 therefore studies a **governance intervention over research trajectories**, not generic research-agent capability.
...
2. the same available evidence is passed through the ORION-24 governance contract before promotion.
...
This refresh authorizes no claim that ORION-24 is the first system to evaluate research quality, preserve negatives, use expert adjudication, benchmark research agents, or employ multi-agent/reflection/preregistration mechanisms.
