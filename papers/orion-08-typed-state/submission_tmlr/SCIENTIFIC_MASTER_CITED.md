...
Many underlying ingredients are mature. Value-of-information methods [@russell1991rightthing] ask which measurement is worth purchasing. Database and workflow provenance [@buneman2001provenance; @cheney2009provenance] track how results were derived. Agent memory systems increasingly detect and revise stale state. Context-governance systems track versions, provenance, selectors and artifact identity. ORION-04 does not claim any of these primitives as new.
...
## Typed priors: which unknown is worth probing?
...
## Scope invalidation: when does an old failure still apply?
...
## Interval verification: which uncertainty can change the choice?
...
## Transport: local validity is not chain authority
...
## Experiment selection: entropy and decision relevance differ
...
## Representation edits: reuse, remint or re-derive?
...
## Two negative/donor outcomes

### Typed failure state without allocation-policy novelty
...
### Crossover predictor absorbed on the original world
...
## Relation to provenance/context governance and ORION-23
