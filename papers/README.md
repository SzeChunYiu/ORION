...
| 02 | [ORION-02 — FiberGuard Finite Fibre](orion-02-fiberguard-finite-fibre/) | ☐ PR pending — Tier-B package **GREEN** | TMLR | Machine Learning / theory specialist | `B0` | `T2` | **No scientific or package blocker.** Merge the checksum-closed dual-route package from `submission/tier-b-final-20260901/`; only author-controlled arXiv/OpenReview portal actions remain. | Prospective heterogeneous transfer with valid per-task bounds is required only for a broader empirical claim. | ☐ | ☐ |
| 03 | [ORION-03 — Typed-Merge Falsification](orion-03-typed-merge-falsification/) | ☐ PR pending — Tier-B package **GREEN** | Journal of Automated Reasoning | Theoretical Computer Science | `B0` | `T2` | **No scientific or package blocker.** Merge the checksum-closed identified dual-route package from `submission/tier-b-final-20260901/`; only author-controlled arXiv/JAR portal actions remain. | Independently governed native trust/provenance ecosystems are required only for a broader transfer claim. | ☐ | ☐ |
...
| 08 | [ORION-08 — Typed State](orion-08-typed-state/) | ☐ Tier-B closure PR pending | TMLR | AIJ | `B0` | `T0` | **No scientific blocker for the bounded paper.** V4 integrates the corrected finite criterion and all completed real-data boundaries. | **None for the bounded TMLR attempt.** Broader practical superiority would require new prospective external evidence. | ☐ | ☐ |
...
| `orion-08-typed-state/` | typed/scoped epistemic state under partial knowledge | `manuscript/` + `CLAIM_LEDGER_V4.md` | controlled mechanism paper with corrected finite criterion and mixed bounded real-data transfer |
