...
|---:|---|---|---|---|---|---|---|---|---|---|
| 01 | [ORION-01 — Certificate Realization](orion-01-certificate-realization/) | ☑ `main` — package **GREEN** | Quantum | Theoretical Computer Science | `B0` | `T2` | **No scientific or package blocker.** File the merged ORION-01+05 V4 dual-route package; only author-controlled arXiv/Quantum portal actions remain. | Independent priority/proof authority and production transfer would be required only for a broader or stronger route. | ☐ | ☐ |
| 02 | [ORION-02 — FiberGuard Finite Fibre](orion-02-fiberguard-finite-fibre/) | ☑ `main` — package **GREEN** | TMLR | Machine Learning / theory specialist | `B0` | `T2` | **No scientific or package blocker.** File the checksum-closed dual-route package; only author-controlled arXiv/OpenReview portal actions remain. | Prospective heterogeneous transfer with valid per-task bounds is required only for a broader empirical claim. | ☐ | ☐ |
| 03 | [ORION-03 — Typed-Merge Falsification](orion-03-typed-merge-falsification/) | ☑ `main` — package **GREEN** | Journal of Automated Reasoning | Theoretical Computer Science | `B0` | `T2` | **No scientific or package blocker.** File the checksum-closed identified dual-route package; only author-controlled arXiv/JAR portal actions remain. | Independently governed native trust/provenance ecosystems are required only for a broader transfer claim. | ☐ | ☐ |
...
| 08 | [ORION-08 — Typed State](orion-08-typed-state/) | ☑ `main` — package **GREEN** | TMLR | AIJ | `B0` | `T0` | **No scientific or package blocker.** File the current attributed arXiv and anonymous TMLR routes. | **None for the bounded TMLR attempt.** Real-system transfer is optional successor evidence. | ☐ | ☐ |
| 09 | [ORION-09 — Compilation Regime Geometry](orion-09-compilation-regime-geometry/) | ☑ `main` provenance | **Merged into ORION-10** | -- | `MERGED` | `MERGED` | **Do not submit separately.** Its exact geometry and negative transfer result are retained in ORION-10. | Reopen only for a genuinely new frozen question beyond the merged paper. | -- | -- |
| 10 | [ORION-10 — Certified Static Forecasting](orion-10-certified-static-forecasting/) | ☑ `main` — package **GREEN** | Quantum | Theoretical Computer Science | `B0` | `T0` | **No scientific or package blocker.** File the current `quant-ph` / CC BY 4.0 package. | **None for the bounded Quantum attempt.** Scoped B′ remains `CANNOT_CHECK` and belongs to successor work if pursued. | ☐ | ☐ |
...
| 12 | [ORION-12 — Open-World Scientific Knowledge Discovery](orion-12-open-world-scientific-discovery/) | ☑ `main` — package built | Information Processing & Management | JASIST-style information-science venue | `B0` | `T1` | **No new science or package repair required.** Author confirmation and portal actions remain. | A superiority claim is a separate `T2` successor requiring fresh matched external evidence. | ☐ | ☐ |
| 13 | [ORION-13 — Global Knowledge Portrait](orion-13-global-knowledge-portrait/) | ☑ `main` — package built | F1000Research Brief Report | Data & Knowledge Engineering | `B1` | `T1` | **No new science or package repair required.** DOI and author-controlled filing inputs remain. | Anti-confounded external semantic corpus is required only for broader coordinate/semantic utility. | ☐ | ☐ |
