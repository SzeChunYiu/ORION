...
| 13 | [ORION-13 — Coordinate-Governed Scientific Mapping](orion-13-global-knowledge-portrait/) | PR #2068 — bounded Brief Report package complete | F1000Research Brief Report | arXiv | `B1` | `T1` | No scientific or manuscript technical blocker; complete author-controlled filing inputs and submit the seven-page bounded report. | Optional successor only: independently governed naturalistic/raw-text integration with strong comparators and downstream utility. | ☐ | ☐ |
...
| ORION-13 | Coordinate-Governed Scientific Mapping | `orion-13-global-knowledge-portrait/` |
