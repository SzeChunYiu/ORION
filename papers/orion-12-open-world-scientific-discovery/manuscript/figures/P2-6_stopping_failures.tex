...
\node[anchor=east] at (-0.35,1.18) {Governed controller};
\node[anchor=west] at (4.88,1.18) {0};
\node[anchor=east] at (-0.35,2.18) {Protocol-driven review};
...
\node[anchor=west,font=\small] at (0,7.0) {390 frozen tasks; descriptive mechanism evidence};
\end{tikzpicture}
